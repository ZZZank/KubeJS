...
public interface MutableComponentKJS extends Component, Iterable<Component>, JsonSerializable, WrappedJS {

    @Override
    default Iterator<Component> iterator() {
        throw new AssertionError("Not implemented by mixin");
    }
    ...
    default MutableComponent kjs$color(@Nullable Color c) {
        var col = c == null ? null : c.createTextColorKJS();
    ...
    default MutableComponent kjs$strikethrough(@Nullable Boolean value) {
        return kjs$self().setStyle(getStyle().applyFormat(ChatFormatting.STRIKETHROUGH));
    }
    ...
    default MutableComponent kjs$obfuscated(@Nullable Boolean value) {
        return kjs$self().setStyle(getStyle().applyFormat(ChatFormatting.OBFUSCATED));
    }
